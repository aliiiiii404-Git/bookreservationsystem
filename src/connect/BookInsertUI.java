...
public class BookInsertUI extends JFrame {
    ...
    public BookInsertUI() {
        ...
        btnSubmit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                AddBooksToDatabase.addNeedBook(title, publisher, author, owner1, owner2, owner3);
                JOptionPane.showMessageDialog(null, "书籍已成功添加到 needbooks 数据库.");
            }
        });
    }
    ...
    public static void a(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                BookInsertUI ex = new BookInsertUI();
                ex.setVisible(true);
            }
        });
    }
